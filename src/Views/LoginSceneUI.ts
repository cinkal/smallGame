...
class LoginSceneView extends ui.LoginViewUI {
    ...
    public registerEvent() : void{
        ...
        this._timeOutTimer = setTimeout(()=>{
            smallGame.MsgToast.showToast("NetWork Error, please try again later.");
    ...
    private transToNextScene(): void{
        ...
        // if (!this._reset) smallGame.Director.getInstance().replaceScene(laya.MainScene.create(this._nextSceneData));
    }
