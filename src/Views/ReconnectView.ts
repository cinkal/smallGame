...
class ReconnectView extends ui.ReconnectUI {
	...
	public initView() : void {
        ...
        let rotationAction = smallGame.RotateTo.create(3, -720);
        let forever = smallGame.RepeatForever.create(rotationAction);
		smallGame.Director.getInstance().getActionManager().addAction(forever ,this._line, false);
