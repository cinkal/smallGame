...
(function (smallGame) {
    ...
    var NetDispatcher = /** @class */ (function (_super) {
        ...
        function NetDispatcher() {
            ...
            _this._state = new smallGame.NetState();
            _this._state.reset();
        ...
        NetDispatcher.prototype.dequeue = function (delta) {
            ...
            while (this._tcp && this._tcp.getRecvQueue().getMsgNum() > -1) {
                ...
                if (event._cmd == NetEventCmd.CloseSocket) {
                    ...
                    smallGame.Director.getInstance().getEventDispatcher().event(EVENT_NET, smallGame.NetEventCapturor.create(EVENT_NET, EVENT_NET_CLOSE, this._id));
                    break;
                }
        ...
        NetDispatcher.prototype.powerOn = function (ip, port, callback) {
            ...
            this._port = port;
            this._state.reset();
            this._tcp = new smallGame.TcpClient(ip, port);
            this._tcp.start();
        ...
        NetDispatcher.prototype.registerEvent = function () {
            smallGame.Director.getInstance().getEventDispatcher().on(EVENT_NET, this, this.startNetDispatcher);
        };
        NetDispatcher.prototype.unRegsiterEvent = function () {
            smallGame.Director.getInstance().getEventDispatcher().off(EVENT_NET, this, this.startNetDispatcher);
        };
        ...
        NetDispatcher.prototype.timeoutHandle = function () {
            ...
            if (!this._state._waitRebuild) {
                ...
                smallGame.Director.getInstance().getEventDispatcher().event(EVENT_NET, smallGame.NetEventCapturor.create(EVENT_NET, EVENT_NET_REBUILD, this._id));
            }
        };
    ...
    smallGame.NetDispatcher = NetDispatcher;
})(smallGame || (smallGame = {}));
