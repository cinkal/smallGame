...
(function (smallGame) {
    ...
    var TcpClient = /** @class */ (function () {
        function TcpClient(ip, port, isIpv6) {
            ...
            this._socket = null;
            this._sendQueue = new smallGame.TcpQueue();
            this._recvQueue = new smallGame.TcpQueue();
        }
        ...
        TcpClient.prototype.onSocketeOpen = function (evt) {
            ...
            smallGame.Director.getInstance().getEventDispatcher().event(EVENT_NET, smallGame.NetEventCapturor.create(EVENT_NET, EVENT_NET_START, evt.code));
        };
        TcpClient.prototype.onSocketClose = function (evt) {
            ...
            if (this._sendQueue.getConnectStatus()) {
                smallGame.Director.getInstance().getEventDispatcher().event(EVENT_NET, smallGame.NetEventCapturor.create(EVENT_NET, EVENT_NET_CLOSE));
            }
