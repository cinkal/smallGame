...
(function (smallGame) {
    var ResourceManager = /** @class */ (function (_super) {
        ...
        ResourceManager.prototype.loadCommonRes = function () {
            this.loadResWithArray(smallGame.CommonConfig.configCache, true);
        };
        ResourceManager.prototype.init = function () {
            this._loadedResMap = new smallGame.Vector();
            this._buildingsTempletMap = new smallGame.Map();
            this._fontsMap = new smallGame.Map();
            this._eventDispatcher = smallGame.Director.getInstance().getEventDispatcher();
            this.loadCommonRes();
            return true;
        };
        ...
        ResourceManager.prototype.loadSceneRes = function (scene) {
            ...
            switch (scene) {
                ...
                case ScenesType.LoginScene:
                    {
                        resArray = smallGame.LoginSceneConfig.configCache;
    ...
    smallGame.ResourceManager = ResourceManager;
})(smallGame || (smallGame = {}));
