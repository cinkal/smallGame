...
(function (smallGame) {
    ...
    var PointArray = /** @class */ (function () {
        ...
        PointArray.prototype.initWithCapatity = function () {
            this._controlPoints = new smallGame.Vector();
            return true;
        };
        ...
        PointArray.prototype.reverse = function () {
            var newArray = new smallGame.Vector();
    ...
    smallGame.PointArray = PointArray;
    ...
    smallGame.CardinalSplineTo = CardinalSplineTo;
    ...
    smallGame.CardinalSplineBy = CardinalSplineBy;
})(smallGame || (smallGame = {}));
