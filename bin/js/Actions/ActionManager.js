...
(function (smallGame) {
    ...
    var ActionManager = /** @class */ (function () {
        function ActionManager() {
            this._targets = new smallGame.Map();
        ...
        ActionManager.prototype.pauseAllRunningActions = function () {
            var idsWithActions = new smallGame.Vector();
            var items = this._targets.getItems();
            for (var key in items) {
                if (items.hasOwnProperty(key)) {
    ...
    smallGame.ActionManager = ActionManager;
    ...
    smallGame.HashElement = HashElement;
})(smallGame || (smallGame = {}));
