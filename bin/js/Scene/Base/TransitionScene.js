...
(function (smallGame) {
    ...
    smallGame.TransitionEaseScene = TransitionEaseScene;
    var TransitionScene = /** @class */ (function (_super) {
        ...
        TransitionScene.prototype.initWithDuration = function (delta, scene) {
            ...
            this._outScene = smallGame.Director.getInstance().getRunningScene();
            if (!this._outScene) {
                this._outScene = smallGame.Scene.create();
        ...
        TransitionScene.prototype.finish = function () {
            smallGame.Director.getInstance().replaceScene(this._inScene);
    ...
    smallGame.TransitionScene = TransitionScene;
    var TransitionFade = /** @class */ (function (_super) {
        ...
        TransitionFade.prototype.onEnter = function () {
            ...
            var actions = new smallGame.Vector();
            actions.push(smallGame.FadeIn.create(this._duration / 2));
            actions.push(smallGame.CallFunc.create(Laya.Handler.create(this, this.hideOutShowIn)));
            actions.push(smallGame.FadeOut.create(this._duration / 2));
            actions.push(smallGame.CallFunc.create(Laya.Handler.create(this, this.finish)));
            var seq = smallGame.Sequence.create(actions);
            f.runAction(seq);
        };
    ...
    smallGame.TransitionFade = TransitionFade;
})(smallGame || (smallGame = {}));
