...
(function (smallGame) {
    var Director = /** @class */ (function () {
        ...
        Director.prototype.init = function () {
            ...
            this._runningScene = null;
            this._nextScene = null;
            this._sceneStack = new smallGame.Vector();
            this._pasused = false;
            this._invalid = false;
            this._actionManager = new smallGame.ActionManager();
            this._eventDispatcher = new Laya.EventDispatcher();
            this._purgeDirectorInNextLoop = false;
            this._restartDirectorInNextLoop = false;
            this._scheduler = new smallGame.Scheduler();
            var gameManager = smallGame.GameManager.getInstace();
            this.setInterfaceGameMgr(gameManager);
            this._reconnectManger = smallGame.FReconnect.create();
            this._reconnectManger.zOrder = 10;
            Laya.stage.addChild(this._reconnectManger);
            smallGame.ResourceManager.getInstance();
        ...
        Director.prototype.setNextScene = function () {
            ...
            var runningIsTransition = (this._runningScene instanceof smallGame.TransitionScene) ? true : false;
            var newIsTransition = (this._nextScene instanceof smallGame.TransitionScene) ? true : false;
            if (!newIsTransition) {
                if (this._runningScene) {
