...
(function (BuildingType) {
    BuildingType[BuildingType["Castle"] = 1] = "Castle";
    BuildingType[BuildingType["LumberMill"] = 2] = "LumberMill";
    BuildingType[BuildingType["Shaft"] = 3] = "Shaft";
    BuildingType[BuildingType["Fishpond"] = 4] = "Fishpond";
    BuildingType[BuildingType["CrocodilePool"] = 5] = "CrocodilePool";
    BuildingType[BuildingType["Dockyard"] = 6] = "Dockyard";
    BuildingType[BuildingType["Temple"] = 7] = "Temple";
    BuildingType[BuildingType["Lighthouse"] = 8] = "Lighthouse";
    BuildingType[BuildingType["MAX"] = 9] = "MAX"; // 为了方便循环，永远在最后的值
...
(function (MoveDirection) {
    MoveDirection[MoveDirection["MOVE_TOP"] = 0] = "MOVE_TOP";
    MoveDirection[MoveDirection["MOVE_DOWM"] = 1] = "MOVE_DOWM";
    MoveDirection[MoveDirection["MOVE_LEFT"] = 2] = "MOVE_LEFT";
    MoveDirection[MoveDirection["MOVE_RIGHT"] = 3] = "MOVE_RIGHT";
})(MoveDirection || (MoveDirection = {}));
var BlueHoleType;
(function (BlueHoleType) {
    BlueHoleType[BlueHoleType["ORDINARY"] = 0] = "ORDINARY";
    BlueHoleType[BlueHoleType["ELITE"] = 1] = "ELITE";
})(BlueHoleType || (BlueHoleType = {}));
var FleetType;
(function (FleetType) {
    FleetType[FleetType["DEFENSE"] = 1] = "DEFENSE";
    FleetType[FleetType["EXPLORE"] = 2] = "EXPLORE";
    FleetType[FleetType["VOYAGE"] = 3] = "VOYAGE";
})(FleetType || (FleetType = {}));
var FleetFrom;
(function (FleetFrom) {
    FleetFrom[FleetFrom["NORMAL"] = 0] = "NORMAL";
    FleetFrom[FleetFrom["FROM_DOCK"] = 1] = "FROM_DOCK";
    FleetFrom[FleetFrom["FROM_FIGHT"] = 2] = "FROM_FIGHT";
})(FleetFrom || (FleetFrom = {}));
...
var ITEM_TYPE;
(function (ITEM_TYPE) {
    ITEM_TYPE[ITEM_TYPE["ITEM_VIP_POINT"] = 15] = "ITEM_VIP_POINT";
})(ITEM_TYPE || (ITEM_TYPE = {}));
var REPLACE_VIEW_STATUS;
(function (REPLACE_VIEW_STATUS) {
    REPLACE_VIEW_STATUS[REPLACE_VIEW_STATUS["IDLE"] = 0] = "IDLE";
    REPLACE_VIEW_STATUS[REPLACE_VIEW_STATUS["IN"] = 1] = "IN";
    REPLACE_VIEW_STATUS[REPLACE_VIEW_STATUS["OUT"] = 2] = "OUT";
})(REPLACE_VIEW_STATUS || (REPLACE_VIEW_STATUS = {}));
...
function getSignDayConf(day, conf) {
    switch (day) {
        case 0:
